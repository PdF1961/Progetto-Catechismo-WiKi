...
- **Wiki-lint pass complete (2026-07-18b, post-Iota Unum)** — see [[lint-report-2026-07-18b]]. Iota Unum batch itself: zero issues. Found and fixed one pre-existing, unrelated bug: [[Giovanni Paolo II - Sollicitudo Rei Socialis]] had a misspelled filename ("Sollecitudo") causing 2 dead links; renamed and all references corrected.
